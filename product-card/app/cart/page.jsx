              ...
              <CardHeader>
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    {/* <CardDescription className="mt-2">{swap.description}</CardDescription>
                    <div className="flex flex-wrap gap-2 mt-3">
                      <Badge variant="secondary">{swap.category}</Badge>
                      <Badge 
                        variant="outline" 
                      >
                        {offer.status_offer}
                  ...
                  <div className="text-right">
                    <div className="text-sm text-muted-foreground">
                      Your items: {swapItems.filter(u => u.user_id !== offer.to_user_id).length} {"    "}
                                  ...
                                  {/* <img
                                      ...
                                      /> */}
                                          <Avatar className="h-12 w-12">
                                            <AvatarImage src={`http://localhost:8055/assets/${userSwaps.find(u => u.id === offer.from_user_id)?.avatar}` || "/placeholder.svg"}
                                            alt={userSwaps.find(u => u.id === offer.from_user_id)?.first_name || t("account")}/>
                                    ...
                                    <div className="w-full h-full flex items-center justify-center" style={{display: 'none'}}>
                                      <User className="h-6 w-6 text-gray-500" />
                                        ...
                                        <span className="text-base"> {userSwaps.find(u => u.id === offer.from_user_id)?.first_name || "Unknown"}</span>
                                    </div>
                                  </div>
